...
def client
  @client ||= Line::Bot::Client.new do |config|
    config.channel_secret = ENV["a635011dbf5f265661ea83c64d0faf52"]
    config.channel_token = ENV["p0XYHyv+vaz/gu4mU2yBjOKCY7s7H/g4kvtBHJ2Ln84/oDHXPQli/UkU3y0Yli+unc+fdZB80n/8d6Ud+U3BVTf6DY71tXkmwiecDHUCTjQT/hT7R8M878XrGzE2TSbX138NGViJlhOOrK4rZm7mawdB04t89/1O/w1cDnyilFU="]
    config.http_options = {
      open_timeout: 5,
      read_timeout: 5,
    }
